...
<model ref="r:8d73cab6-bfca-486c-b6c8-ed6a97a53421(openpme.statements.editor)">
  ...
  <node concept="24kQdi" id="5P7tjdCsQxd">
    <ref role="1XX52x" to="5oki:5P7tjdCsPX9" resolve="Statement" />
    <node concept="3F0ifn" id="5P7tjdCsQxf" role="2wV5jI">
      <node concept="VPxyj" id="5P7tjdCsRjy" role="3F10Kt">
        <property role="VOm3f" value="true" />
      </node>
    </node>
  </node>
  <node concept="24kQdi" id="4KdbJ50lDNm">
    <ref role="1XX52x" to="5oki:4KdbJ50lDMW" resolve="test" />
    <node concept="3F0ifn" id="6dqtJ3azqbe" role="2wV5jI" />
  </node>
</model>
